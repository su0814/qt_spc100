...
enum {
    ...
    SUB_PROJECT_DEBUG_ERROR_REPORT,
};  // CMD_PROJECT_INFO OPTION

enum {
    SUB_READ_STATUS_BASE = 0X00,
    SUB_READ_STATUS_ERROR,
    SUB_READ_STATUS_VERSION,
    SUB_READ_REPLY_BASE = 0X80,
    SUB_READ_REPLY_ERROR,
...
enum {
    SUB_DEVICE_HEARTBEAT_REQUEST  = 0x01,
    SUB_DEVICE_HEARTBEAT_RESPONSE = 0X81,
};
/******************************************/
enum {
    SYNC_ID_COMMON = 0,
