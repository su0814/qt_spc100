...
/* lus user func */
/* 三类输入函数 */
const QStringList sdi_func         = { "sdi1()", "sdi2()", "sdi3()", "sdi4()",  "sdi5()",  "sdi6()",
                               "sdi7()", "sdi8()", "sdi9()", "sdi10()", "sdi11()", "sdi12()" };
const QStringList sai_func         = { "sai1()", "sai2()" };
const QStringList spi_func         = { "spi1_cnt()", "spi2_cnt()" };
const QStringList sqep_func        = { "sqep1_cnt()", "sqep2_cnt()", "pi_sqep1_cnt()", "pi_sqep2_cnt()" };
const QStringList lua_qep_dir_func = { "sqep1_dir()", "sqep2_dir()", "pi_sqep1_dir()", "pi_sqep2_dir()" };
const QStringList const_func       = { "true", "false" };
/* 二类输入函数 */
...
const QStringList a_qep_function = { "sqep1_cnt()", "sqep2_cnt()", "pi_sqep1_cnt()", "pi_sqep2_cnt()" };
const QStringList b_qep_function = { "sqep1_cnt()", "sqep2_cnt()", "pi_sqep1_cnt()", "pi_sqep2_cnt()" };
/* 对二类和三类的输入函数进行汇总 */
...
const QList<QStringList>        cat3_source_function = { sai_func, sdi_func, spi_func, sqep_func, const_func };
...
const QList<QStringList> input_model        = { ai_resource,  di_resource,    pi_resource,
                                         qep_resource, const_resource, irepeater_resource };
