...
public:
    ...
    int                   get_input_point_number();
    int                   get_output_point_number();
    int                   get_input_point_mask();
    int                   get_output_point_mask();
    ...
    bool                  set_input_mask(int mask);
    bool                  set_output_mask(int mask);
