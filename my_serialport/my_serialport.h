...
public:
    ...
    int  port_transmisson_sendframe(uint8_t* frame, int32_t length);
    int  port_cmd_sendframe(uint8_t id, uint8_t type, uint8_t cmd, uint8_t sub, uint8_t* frame, uint16_t length);
